...
return [
    ...
    */
    'auth' => [
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => Nicelizhi\Admin\Auth\Database\Administrator::class,
            ],
        ],
    ...
    */
    'database' => [
        ...
        'permissions_model' => Nicelizhi\Admin\Auth\Database\Permission::class,
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'grid_action_class' => \Nicelizhi\Admin\Grid\Displayers\DropdownActions::class,
